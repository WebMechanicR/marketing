...
<form action="<?php echo DIR_ADMIN; ?>?module=<?php echo $module;?>&action=import" method="post">
...
<?php  }
      ...
      <div class="bt-set">
					<span class="btn standart-size">
						<a href="<?php echo DIR_ADMIN; ?>?module=<?php echo $module;?>&action=import" class="button ajax_link hide-icon" data-module="<?php echo $module;?>">
