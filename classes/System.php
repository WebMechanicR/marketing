	...
	*/
	...
	public function __construct() {
		...
		if(!self::$instance) {
			...
			$protocol = (isset($_SERVER["SERVER_PROTOCOL"]) and strtolower(substr($_SERVER["SERVER_PROTOCOL"],0,5))=='https')? 'https' : 'http';
			...
			if(DEBUG_MODE) {
				...
				new Debug_HackerConsole_Main(!(isset($_SERVER['HTTP_X_REQUESTED_WITH']) and $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest'));
			}
